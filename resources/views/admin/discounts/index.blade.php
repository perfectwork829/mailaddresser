        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/discounts/create') }}" class="btn btn-success btn-sm" title="Add New Discount">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/discounts', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Organization</th><th>Code</th><th>Amount</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($discounts as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->organization }}</td><td>{{ $item->code }}</td><td>{{ $item->amount }}</td>
                                        <td>
