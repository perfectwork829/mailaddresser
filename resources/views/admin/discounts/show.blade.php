...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Discount {{ $discount->id }}</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Organization </th><td> {{ $discount->organization }} </td></tr><tr><th> Code </th><td> {{ $discount->code }} </td></tr><tr><th> Amount </th><td> {{ $discount->amount }} </td></tr>
                                </tbody>
                            </table>
                        </div>
