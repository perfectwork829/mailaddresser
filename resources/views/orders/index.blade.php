        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box sale-primary-color mailaddress_container" id="form_wizard_1">
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <form role="form" class="form-horizontal filter-form search_form" id="submit_form"
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                <div class="input-icon right para-color">
                                                    ...
                                                    <input type="number" class="form-control" name="number_to_purchase"
                                                        min="1" required
                                                        value="{{ $order->number_to_purchase ? $order->number_to_purchase : $order->matching_records }}" />
                                                </div>
                                                <div class="input-icon right para-color">
                                                ...
                                                <button type="submit"
                                                    class="btn sale-primary-color my-10 btn_price">@lang('Update price') <i
                ...
                <div class="portlet-footer address-footer">
                    <button type="button" class="next_btn btn confirm-button sale-primary-color">@lang('Next') <i
                            class="m-icon-swapright m-icon-white"></i></button>
                </div>
            </div>
            <!-- END PAGE CONTENT-->
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('change click', '.filters', function(
            e) { //when clicking and changing sex, age, live_type, phone number      
            console.log(999);
            $.ajax({
                url: '/orders/filters',
                method: 'POST',
        ...
        $(document).on('click', '.upd_btn', function(e) { //getting matching record count(OrderController@create)
            ...
            $.ajax({
                ...
                $('input[name="number_to_purchase"]').val('');
            }).fail(function(data) {
                console.log(data)
            }).always(function() {
