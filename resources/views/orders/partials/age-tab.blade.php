    ...
    <div class="col-md-6">
        <div id="spinner4">
            <div class="input-group">
                ...
                <input type="number" class="spinner-input form-control input-md form-control filters"
                    name="filters[age][from]" id="age_from" value="" />
    ...
    <div class="col-md-6">
        <div id="spinner3">
            <div class="input-group">
                ...
                <input type="number" class="form-control spinner-input form-control input-md filters"
                    name="filters[age][to]" id="age_to" value="" />
                <div class="spinner-buttons input-group-btn">
                    <button type="button" class="btn spinner-down red filters">
                        <i class="fa fa-minus"></i>
                    </button>
