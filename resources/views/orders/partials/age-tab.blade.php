    ...
    <div class="col-md-10">
        <div id="spinner4">
            <div class="input-group">
                ...
                <input type="number" class="spinner-input form-control input-md form-control filters" name="filters[age][from]" id="age_from" value="{{ $order->age['from'] }}"/>
    ...
    <div class="col-md-10">
        <div id="spinner3">
            <div class="input-group">
                ...
                <input type="number" class="form-control spinner-input form-control input-md filters" name="filters[age][to]" id="age_to" value="{{ $order->age['to'] }}"/>
                <div class="spinner-buttons input-group-btn">
                    <button type="button" class="btn spinner-down red filters">
                    <i class="fa fa-minus"></i>
                    </button>
